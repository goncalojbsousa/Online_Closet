...
const filters = [
    {
        ...
        options: [
            ...
            { value: 'Calças', label: 'Calças', checked: true },
            { value: 'Tenis', label: 'Tenis', checked: true },
        ],
    },
    {
        id: 'cor',
                ...
                <div>
                    ...
                    <main className="mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-6">
                            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Bem-vindo ao seu armário!</h1>
